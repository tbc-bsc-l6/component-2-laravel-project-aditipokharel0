            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('modules.store') }}">
                    ...
                    <div>
                        ...
                        <input class="border w-full rounded-md px-3 py-2 mt-1" name="code" value="{{ old('code') }}" />
                        @error('code')
                    ...
                    <div class="mt-4">
                        ...
                        <input class="border w-full rounded-md px-3 py-2 mt-1" name="title" value="{{ old('title') }}" />
                        @error('title')
                            <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <textarea class="border w-full rounded-md px-3 py-2 mt-1" name="description" rows="4">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>

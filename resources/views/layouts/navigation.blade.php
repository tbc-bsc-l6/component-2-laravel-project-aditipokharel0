<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->isTeacher())
                        <x-nav-link :href="route('teacher.modules.index')" :active="request()->routeIs('teacher.modules.*')">
                            My Modules
                        </x-nav-link>
                    @endif
                    ...
                    @if(Auth::user()->isStudent())
                        ...
                        <x-nav-link :href="route('student.enrolments.index')" :active="request()->routeIs('student.enrolments.*')">
                            My Enrolments
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->isTeacher())
                <x-responsive-nav-link :href="route('teacher.modules.index')" :active="request()->routeIs('teacher.modules.*')">
                    My Modules
                </x-responsive-nav-link>
            @endif
            ...
            @if(Auth::user()->isStudent())
                ...
                <x-responsive-nav-link :href="route('student.enrolments.index')" :active="request()->routeIs('student.enrolments.*')">
                    My Enrolments
                </x-responsive-nav-link>
